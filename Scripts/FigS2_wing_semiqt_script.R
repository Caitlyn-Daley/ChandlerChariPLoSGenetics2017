#### Script for plotting the alleleic series for sd and vg mutations in Samarkand and Oregon-R genetic backgrounds at 18 and 24 degC using semi-quantitative wing size measures ####
...
pdf(file="FigureS2_all_allelic_series_semiqt.pdf", height=2*4, width=2.1*5)
...
set.margins()
lineplot.CI(sd.wa.data$Mutation, sd.wa.data$Semiqt_Num, group=sd.wa.data$Background, fixed=T,legend=F, ci.fun= ci.fun, xlab= "Genotype", ylab="Semiquantitative wing measure", main="sd at 24°C", col=c("red","blue"), pch=c(19,19), lty=c(1,1), lwd=2, xaxt="n", ylim=y.axis.lim)
...
set.margins()
lineplot.CI(sd.wa.data$Mutation, sd.wa.data$Semiqt_Num, group=sd.wa.data$Background, fixed=T,legend=F, ci.fun= ci.fun, xlab= "Genotype", ylab="Semiquantitative wing measure", main="sd at 18°C", col=c("red","blue"), pch=c(19,19), lty=c(1,1), lwd=2, xaxt="n", ylim=y.axis.lim)
...
set.margins()
lineplot.CI(vg.wa.data$Mutation, vg.wa.data$Semiqt_Num, group=vg.wa.data$Background, fixed=T,legend=F, ci.fun= ci.fun, xlab= "Genotype", ylab="Semiquantitative wing measure", main="vg at 24°C",col=c("red","blue"), pch=c(19,19), lty=c(1,1), lwd=2, xaxt="n", ylim=y.axis.lim)
#legend (x="topright", xjust=0, legend= c("Oregon-R", "Samarkand"), col=c("red","blue"), pch= c(16,16), lty=c(1,1), bty="n", cex=0.8)
...
set.margins()
lineplot.CI(vg.wa.data$Mutation, vg.wa.data$Semiqt_Num, group=vg.wa.data$Background, fixed=T,legend=F, ci.fun= ci.fun, xlab= "Genotype", ylab="Semiquantitative wing measure", main="vg at 18°C",col=c("red","blue"), pch=c(19,19), lty=c(1,1), lwd=2, xaxt="n", ylim=y.axis.lim)
#legend (x="topright", xjust=0, legend= c("Oregon-R", "Samarkand"), col=c("red","blue"), pch= c(16,16), lty=c(1,1), bty="n", cex=0.8)
